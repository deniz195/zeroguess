...
@pytest.fixture
def double_gaussian_instance():
    """Return a DoubleGaussianFunction instance for testing."""
    return DoubleGaussianFunction()


@pytest.fixture
def sample_data_double_gaussian(double_gaussian_instance):
    ...
    # Generate clean data
    y_clean = double_gaussian_instance(x_data, **true_params)
...
class TestDoubleGaussianWorkflow:
    ...
    def test_full_workflow(
        ...
        estimator = NeuralNetworkEstimator(
            function=double_gaussian_instance,
            param_ranges=param_ranges,
            independent_vars_sampling=independent_vars_sampling,
            make_canonical=double_gaussian_instance.get_canonical_params,
        ...
        create_and_save_visualizations(
            ...
            test_name="test_double_gaussian_full_workflow",
        ...
        if train_losses:
            ...
            training_history_path = os.path.join(
                ...
                f"test_double_gaussian_full_workflow_training_history_{timestamp}.png",
            )
    ...
    def test_peak_separation_sensitivity(self, set_random_seeds, double_gaussian_instance, monkeypatch):
        ...
        independent_vars_sampling = double_gaussian_instance.default_independent_vars
        ...
        for i, true_params in enumerate(separation_scenarios):
            ...
            double_gaussian_instance(x_data, **predicted_params)
            quality = calculate_curve_fit_quality(double_gaussian_instance, x_data, y_data, predicted_params)
            ...
            scenario_name = (
                f"test_double_gaussian_separation_{abs(true_params['center1'] - true_params['center2']):.1f}"
            )
            create_and_save_visualizations(
                function=double_gaussian_instance,
                x_data=x_data,
        ...
        if train_losses:
            ...
            training_history_path = os.path.join(
                VISUALIZATION_OUTPUT_DIR,
                f"test_double_gaussian_separation_training_history_{timestamp}.png",
            )
            fig3.savefig(training_history_path, dpi=300, bbox_inches="tight")
            print(f"Saved training history visualization to: {training_history_path}")
    ...
    def test_visualization_functions(
        ...
        fig1, fig2, _ = create_and_save_visualizations(
            ...
            test_name="test_double_gaussian_workflow",
            monkeypatch=monkeypatch,
        )
        ...
        if train_losses:
            ...
            training_history_path = os.path.join(
                VISUALIZATION_OUTPUT_DIR,
                f"test_double_gaussian_workflow_training_history_{timestamp}.png",
            )
            fig3.savefig(training_history_path, dpi=300, bbox_inches="tight")
            print(f"Saved training history visualization to: {training_history_path}")
    ...
    def test_estimator_performance_benchmark(
        ...
        create_and_save_visualizations(
            ...
            true_params=true_params,
            estimated_params=predicted_params,
            test_name="test_double_gaussian_benchmark",
            monkeypatch=monkeypatch,
        )

    def test_generate_data_method(self, set_random_seeds, double_gaussian_instance):
        ...
        indep_vars, y_data = double_gaussian_instance.generate_data(params)
        ...
        y_expected = double_gaussian_instance(x, **params)
