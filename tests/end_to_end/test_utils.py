...
def create_and_save_visualizations(
    function, x_data, y_data, true_params, estimated_params,
    test_name, monkeypatch=None
):
...
def evaluate_prediction_quality(function, x_data, y_data, true_params, predicted_params, 
                               max_param_error=2.0, max_rmse=5.0, min_correlation=0.5):
