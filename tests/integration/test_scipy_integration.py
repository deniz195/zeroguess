...
class TestScipyIntegration:
    ...
    def test_zeroguess_curve_fit_with_param_ranges(
        ...
        fitted_params = {"amplitude": popt[0], "center": popt[1], "width": popt[2]}
    ...
    def test_zeroguess_curve_fit_calls_scipy(
        self, mock_scipy_curve_fit, set_random_seeds, gaussian_function, sample_data_1d
    ):
    ...
    def test_zeroguess_curve_fit_respects_user_p0(
        ...
        with patch("scipy.optimize.curve_fit") as mock_scipy_curve_fit:
            ...
            popt, pcov = scipy_integration.curve_fit(
                scipy_gaussian, x_data, y_data, param_ranges=param_ranges, p0=user_p0
            )
    ...
    def test_zeroguess_curve_fit_without_param_ranges(
        ...
        with patch("scipy.optimize.curve_fit") as mock_scipy_curve_fit:
            ...
            popt, pcov = scipy_integration.curve_fit(scipy_gaussian, x_data, y_data)
