...
from ..conftest import set_random_seeds, difficult_function
...
class TestLearningFailure:
    ...
    def test_convergence_error(self, set_random_seeds, difficult_function):
        ...
        estimator = FailingEstimator(
            difficult_function, param_ranges, independent_vars_sampling, fail_type='error'
        )
    ...
    def test_convergence_warning(self, set_random_seeds, difficult_function):
        ...
        estimator = FailingEstimator(
            difficult_function, param_ranges, independent_vars_sampling, fail_type='warning'
        )
    ...
    def test_silent_failure_prediction_quality(self, set_random_seeds, difficult_function):
        ...
        estimator = FailingEstimator(
            difficult_function, param_ranges, independent_vars_sampling, fail_type='silent'
        )
    ...
    def test_recovery_from_failure(self, set_random_seeds, difficult_function):
        ...
        with patch.object(FailingEstimator, 'train', return_value={"loss": 0.1, "val_loss": 0.2, "converged": True}) as mock_train:
